...
export const MACHTEX: Simulation = {
  ...
  steps: [
    // ===== Q1 =====
    {
      ...
      approach: [
        ' Compute 2002 operating income. Revenue = 200 \u00D7 CHF 40,000 = CHF 8,000,000. Direct materials = 300,000 kg \u00D7 CHF 8 = CHF 2,400,000. Other manufacturing = CHF 2,000,000. Design = CHF 1,200,000. S&A = CHF 1,000,000. Operating income = CHF 8,000,000 \u2212 CHF 2,400,000 \u2212 CHF 2,000,000 \u2212 CHF 1,200,000 \u2212 CHF 1,000,000 = CHF 1,400,000.',
        ' Compute 2003 operating income. Revenue = 210 \u00D7 CHF 42,000 = CHF 8,820,000. Direct materials = 310,000 kg \u00D7 CHF 8.50 = CHF 2,635,000. Other manufacturing = CHF 2,025,000. Design = CHF 1,212,000. S&A = CHF 940,500. Operating income = CHF 8,820,000 \u2212 CHF 2,635,000 \u2212 CHF 2,025,000 \u2212 CHF 1,212,000 \u2212 CHF 940,500 = CHF 2,007,500.',
        ' Note the change. Operating income increased by CHF 607,500 (from CHF 1,400,000 to CHF 2,007,500), a 43% improvement. The variance analysis in Q2 will decompose this into its component drivers.',
      ],
      answer:
    ...
    // ===== Q2 =====
    {
      ...
      approach: [
        ' CM per unit = CHF 40,000 \u2212 1,500 \u00D7 CHF 8 = CHF 28,000. Volume variance = (210 \u2212 200) \u00D7 CHF 28,000 = +CHF 280,000.',
        ' Compute the selling price variance. Evaluated at actual volume: 210 \u00D7 (CHF 42,000 \u2212 CHF 40,000) = +CHF 420,000. The price increase to CHF 42,000 is the largest favorable variance, reflecting the market\'s acceptance of the superior D4H design.',
        ' Compute the material efficiency variance. Budget efficiency = 300,000 / 200 = 1,500 kg/unit. Actual = 310,000 / 210 \u2248 1,476 kg/unit. Efficiency improved by 24 kg/unit. Valued at base-year price: \u2212210 \u00D7 (1,476 \u2212 1,500) \u00D7 CHF 8 = +CHF 40,000 (approximately). Favorable: the factory used less material per machine.',
        ' Compute the material price variance. Price rose from CHF 8 to CHF 8.50/kg. Valued at actual quantity: \u2212210 \u00D7 1,476 \u00D7 (CHF 8.50 \u2212 CHF 8.00) = \u2212CHF 155,000 (approximately). Unfavorable: raw material prices increased significantly.',
        ' Compute the manufacturing cost variance. This is a direct comparison since these costs depend on capacity, not volume. Variance = \u2212(CHF 2,025,000 \u2212 CHF 2,000,000) = \u2212CHF 25,000. Slightly unfavorable.',
        ' Compute the design cost variance. Design costs are discretionary and set at the start of each year. Variance = \u2212(CHF 1,212,000 \u2212 CHF 1,200,000) = \u2212CHF 12,000. Slightly unfavorable.',
        ' Compute the S&A cost variance. S&A depends on customer count, not sales volume. Variance = \u2212(CHF 940,500 \u2212 CHF 1,000,000) = +CHF 59,500. Favorable, possibly due to fewer customers or improved sales efficiency.',
        ' Reconcile. Total = +CHF 280,000 + CHF 420,000 + CHF 40,000 \u2212 CHF 155,000 \u2212 CHF 25,000 \u2212 CHF 12,000 + CHF 59,500 = +CHF 607,500. Matches the total change.',
      ],
      answer:
    ...
    // ===== Q3 =====
    {
      ...
      approach: [
        ' Identify the revenue-side success. The company performed better mainly because it sold more units (+10) at a higher price (+CHF 2,000). Together, these two revenue effects account for +CHF 700,000, which is more than the total improvement. This suggests strong market positioning and pricing power for the superior D4H design.',
        ' Assess cost management. On the cost side, results are mixed. Material efficiency improved (+CHF 40,000) and S&A costs decreased (+CHF 59,500). But material prices rose (\u2212CHF 155,000), manufacturing costs increased slightly (\u2212CHF 25,000), and design costs edged up (\u2212CHF 12,000). Net cost variances are approximately \u2212CHF 93,000.',
        ' Flag a potential trade-off. The favorable material price variance (\u2212CHF 155,000) could be related to broader commodity price trends beyond the manager\'s control. Conversely, the efficiency improvement may reflect genuine operational improvements.',
        ' Note the S&A cost reduction. The CHF 59,500 S&A savings could indicate fewer customers (a concern if it signals lost market presence) or more efficient sales operations (positive). Further investigation is needed.',
      ],
      answer:
    ...
    // ===== Q4 =====
    {
      ...
      approach: [
        ' Propose decomposing the volume variance. The current volume variance (+CHF 280,000) does not distinguish between overall market growth and Machtex\'s share gain. If the textile machine market grew by 5% and Machtex grew by 5%, the manager deserves no special credit. But if the market was flat and Machtex grew, the manager\'s commercial efforts were effective.',
        ' Define the decomposition. Market-size variance = change in total market \u00D7 Machtex\'s base-year market share \u00D7 base-year contribution margin. Market-share variance = actual market \u00D7 change in Machtex\'s share \u00D7 base-year contribution margin. This decomposition helps separate controllable performance (market share) from uncontrollable environment (market size).',
        ' Explain the benefit. For performance evaluation, the market-share component is more informative about the manager\'s effort and skill. The market-size component reflects industry trends that no single manager can control. This refinement improves the informativeness of the variance analysis for compensation and evaluation decisions.',
      ],
      answer:
