...
export const LIQUEURS_DE_MONTAGNE: Simulation = {
  ...
  steps: [
    // ===== PART 1 \u2014 Variance Analysis =====
    {
      ...
      formulaTex:
        'V_{vol} = (N_a - N_b) \\times CM_b = (400{,}000 - 500{,}000) \\times 4.50 = -\\text{€} 450{,}000',
      formulaLegend:
      ...
      approach: [
        'Budgeted CM per bottle = Price \u20AC9.00 \u2212 Fruit (0.40 \u00d7 \u20AC5.00 = \u20AC2.00) \u2212 Other VC \u20AC2.50 = \u20AC4.50.',
    ...
    },
    {
      ...
      formulaTex:
        'V_{price} = (P_a - P_b) \\times N_a = (8.375 - 9.00) \\times 400{,}000 = -\\text{€} 250{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'V_{eff} = -(Q_a - Q_b) \\times C_b \\times N_a = -(0.45 - 0.40) \\times 5.00 \\times 400{,}000 = -\\text{€} 100{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'V_{input} = -(C_a - C_b) \\times Q_a \\times N_a = -(5.25 - 5.00) \\times 0.45 \\times 400{,}000 = -\\text{€} 45{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'V_{ovc} = -(OVC_a - OVC_b) \\times N_a = -(2.45 - 2.50) \\times 400{,}000 = +\\text{€} 20{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'V_{FC} = FC_b - FC_a = 800{,}000 - 785{,}000 = +\\text{€} 15{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'V_{OH} = OH_b - OH_a = 225{,}000 - 225{,}000 = \\text{€} 0',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'Bonus = 10\\% \\times \\max(0,\\; \\text{Favorable Variance}) = 10\\% \\times 0 = \\text{€} 0',
      formulaLegend:
        'The bonus is 10% of the total favorable variance. Since the overall variance is unfavorable (\u2212\u20AC810,000), the bonus is zero.',
      approach: [
        'Sum of all variances = \u2212450k \u2212 250k \u2212 100k \u2212 45k + 20k + 15k + 0 = \u2212\u20AC810,000.',
        'Overall variance is unfavorable. Bonus = \u20AC0.',
      ],
      answer: '\u20AC0',
      keyTakeaway:
    ...
    // ===== PART 2 \u2014 New Product Launch =====
    {
      ...
      formulaTex:
        '\\Delta CF = N \\times (P - VC) = 50{,}000 \\times (8.00 - 5.00) = +\\text{€} 150{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta DP = N \\times (P - VC - OH_{rate}) = 50{,}000 \\times (8.00 - 5.00 - 0.45) = 50{,}000 \\times 2.55 = +\\text{€} 127{,}500',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'OH_{new} = \\frac{225{,}000}{600{,}000} = \\text{€} 0.375 \\quad \\Delta DP = 50{,}000 \\times (8.00 - 5.00 - 0.375) = +\\text{€} 131{,}250',
      formulaLegend:
    ...
    // ===== PART 3 \u2014 International Pricing =====
    {
      ...
      formulaTex:
        'FC_{unit} = \\frac{FC}{N_{total}} = \\frac{800{,}000}{525{,}000} = \\text{€} 1.524',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'P_{exp} = (VC + FC_{unit}) \\times 1.20 = (5.00 + 1.524) \\times 1.20 = 6.524 \\times 1.20 = \\text{€} 7.83',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta CF = N \\times (P_{exp} - VC) = 25{,}000 \\times (7.83 - 5.00) = 25{,}000 \\times 2.83 = +\\text{€} 70{,}750',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'FC_{unit} = \\frac{800{,}000}{475{,}000} = \\text{€} 1.684 \\quad P_{new} = (5.00 + 1.684) \\times 1.20 = \\text{€} 8.02',
      formulaLegend:
        'N_total = 450,000 + 25,000 = 475,000 bottles. Lower volume raises the FC per unit, which raises the price.',
      approach: [
        'New total volume = 450,000 domestic + 25,000 export = 475,000 bottles.',
        'New FC per unit = 800,000 / 475,000 = \u20AC1.684.',
        'New full cost = \u20AC5.00 + \u20AC1.684 = \u20AC6.684.',
        'New export price = \u20AC6.684 \u00d7 1.20 = \u20AC8.02 (up from \u20AC7.83).',
      ],
    ...
    // ===== PART 4 \u2014 Transfer Pricing =====
    {
      ...
      formulaTex:
        'TP = (VC + FC_{unit} + OH) \\times 1.10 = (4.50 + 1.455 + 0.45) \\times 1.10 = 6.405 \\times 1.10 = \\text{€} 7.05',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta CF = N \\times (P_{ext} - VC_{C} - VC_{V}) = 50{,}000 \\times (12.00 - 4.50 - 3.00) = 50{,}000 \\times 4.50 = +\\text{€} 225{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta DP_C = N \\times (TP - VC - OH) = 50{,}000 \\times (7.05 - 4.50 - 0.45) = 50{,}000 \\times 2.10 = +\\text{€} 105{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta DP_V = N \\times (P_{ext} - TP - VC_V) = 50{,}000 \\times (12.00 - 7.05 - 3.00) = 50{,}000 \\times 1.95 = +\\text{€} 97{,}500',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'TP_{min} = VC_C + OH = 4.50 + 0.45 = \\text{€} 4.95 \\quad TP_{max} = P_{ext} - VC_V = 12.00 - 3.00 = \\text{€} 9.00',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta CF = 50{,}000 \\times (12.00 - 4.50 - 3.00) = +\\text{€} 225{,}000',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'TP_{new} = (4.50 + 1.455 + 0.50) \\times 1.10 = 6.455 \\times 1.10 = \\text{€} 7.10',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'TP_{min} = 4.50 + 0.50 = \\text{€} 5.00 \\quad TP_{max} = 12.00 - 3.00 - 0.50 = \\text{€} 8.50',
      formulaLegend:
    ...
    },
    {
      ...
      formulaTex:
        'TP_{min} = TP_{max} \\Rightarrow 4.50 + OH = 12.00 - 3.00 - OH \\Rightarrow 2 \\times OH = 4.50 \\Rightarrow OH = \\text{€} 2.25',
      formulaLegend:
    ...
    // ===== PART 5 \u2014 System Critique =====
    {
      ...
      approach: [
        'Variance: Budget at 500,000 vs actual 400,000. Consider decomposing volume into market size and share. Fruit efficiency variance warrants operational investigation.',
        'Cost allocation: Fixed OH per distillery is clean, but per-bottle OH for pricing makes prices volume-dependent.',
        'Pricing: Full-cost-plus-20% creates death spiral risk (Q15). Lower demand raises prices, which may lose more customers.',
        'Transfer pricing: TP of \u20AC7.05 falls within congruence range (\u20AC4.95\u2013\u20AC9.00), but is fragile to OH rate changes (collapses at \u20AC2.25/bottle).',
        'Incentives: All-or-nothing bonus means Claire earns \u20AC0 despite favorable FC and OVC variances. Discourages risk-taking and invites budget gaming.',
      ],
      answer:
