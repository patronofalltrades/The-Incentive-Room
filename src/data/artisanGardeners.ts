...
export const ARTISAN_GARDENERS: Simulation = {
  ...
  steps: [
    ...
    // ===== PART 3.2 =====
    {
      ...
      formulaTex: '\\Delta CF_{Alt1 - Alt2} = 0 - (-4 \\times 25{,}000) = +100{,}000',
      formulaLegend: 'Alt 1: SE does the work (VC = $840/contract, no additional fixed costs). Alt 2: NE hires 4 gardeners ($100k extra) and performs the work itself at the same VC.',
      approach: [
        'Step 1: Both alternatives generate the same external revenue (100 × $2,000 = $200,000) and the same variable cost ($840/contract). The only difference is whether SE does the work (Alt 1) or NE hires gardeners to do it (Alt 2).',
        'Step 2: Alt 1 company cash flow = 100 × ($2,000 − $840) = +$116,000.',
        'Step 3: Alt 2 company cash flow = 100 × ($2,000 − $840) − (4 × $25,000) = $116,000 − $100,000 = +$16,000.',
        'Step 4: Alt 1 is better by $100,000 for the company. Hiring gardeners is wasteful duplication — SE already has the capacity and skills.',
      ],
      answer: 'Alt 1 (internal transfer) saves AGL $100,000 versus Alt 2 (hiring)',
      keyTakeaway: '💡 The company clearly prefers Alt 1. The test is whether the transfer pricing system motivates NE to choose Alt 1 over Alt 2. If NE prefers Alt 2 despite the company preferring Alt 1, the system has goal incongruence.',
    },
    {
      id: 'q21',
      partLabel: 'Part 3.2 — Hire vs Transfer',
