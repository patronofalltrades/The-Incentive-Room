...
export const ARTISAN_GARDENERS: Simulation = {
  ...
  steps: [
    // ===== PART 1.1 =====
    {
      ...
      approach: [
        'CM_b per contract = 3,600 − (70 × 25) − 400 = $1,450.',
    ...
    },
    {
      ...
      approach: [
        ...
        'Old bonus = 10% × 60,000 = $6,000. New bonus = 10% × 510,000 = $51,000.',
        'Δ Bonus = $51,000 − $6,000 = +$45,000.',
      ],
    ...
    // ===== PART 2.4 =====
    {
      ...
      approach: [
        'Without maintenance: N = 900, FC_alloc = 1,350 × (900/1,500) = 810. ADP = 3,150 − 1,080 − 450 − 810 − 210 = $600,000.',
        'With maintenance: N = 1,200, FC_alloc = 1,350 × (1,200/1,500) = 1,080. Revenue = 3,150 + 750 = 3,900. VC = 1,080 + 450 + 300 = 1,830. ADP = 3,900 − 1,830 − 1,080 − 210 = $780,000.',
        'Δ Bonus = 10% × (780 − 600) = 10% × 180 = $18,000.',
      ],
    ...
    },
    {
      ...
      approach: [
        ...
        'Δ DP_NE = 200,000 − 264,000 = −$64,000.',
      ],
    ...
    },
    {
      ...
      approach: [
        'TP revenue = 100 × 2,640 = $264,000.',
        'VC = 100 × 840 = $84,000.',
        'FC allocation change: FC is fixed but now spread over 1,000 instead of 900 contracts. The per-contract FC drops, benefiting existing contracts too.',
        'Δ DP_SE = 264,000 − 84,000 = +$180,000 in contribution. But FC is fixed so no incremental FC.',
        'Net Δ DP_SE = +$180,000.',
      ],
    ...
    // ===== PART 4.1 =====
    {
      ...
      approach: [
        ...
        '2023-2025 each: Revenue = 50 × 9,000 = 450,000. VC = 50 × 5,000 = 250,000. Hire = 2 × 25,000 = 50,000.',
    ...
    // ===== PART 4.2 =====
    {
      ...
      approach: [
        '2023: BV = 420,000. RI = 10,000 − 0.10 × 420,000 = 10,000 − 42,000 = −$32,000.',
        '2024: BV = 280,000. RI = 10,000 − 0.10 × 280,000 = 10,000 − 28,000 = −$18,000.',
        '2025: BV = 140,000. RI = 10,000 − 0.10 × 140,000 = 10,000 − 14,000 = −$4,000.',
      ],
    ...
    },
    {
      ...
      approach: [
        '2023: Δ RI = −32,000 (decrease from zero baseline). Bonus = $0.',
        '2024: Δ RI = −18,000 − (−32,000) = +14,000 (RI improved). Bonus = 10% × 14,000 = $1,400.',
        '2025: Δ RI = −4,000 − (−18,000) = +14,000 (RI improved). Bonus = 10% × 14,000 = $1,400.',
      ],
    ...
    // ===== PART 5 =====
    {
      ...
      approach: [
        'Variance: Budget was optimistic (1,200 vs 900 actual). Consider decomposing volume into market size and share. Materials efficiency and input price variances were both favorable — investigate if quality dropped.',
        'Pricing: Full-cost pricing ($3,007) exceeds market price ($2,500). Allocating idle capacity cost into price risks the death spiral. Capacity-based allocation (Part 2.3) reduces this risk.',
        'Transfer pricing: Full-cost + 10% TP ($2,640) exceeds NE external price ($2,000). Goal congruence fails. TP should be between VC ($840) and external price ($2,000). Negotiated or market-based TP would work better.',
        'Performance measure: Divisional Profit with fixed OH allocation is reasonable, but including volume-based OH (Part 1.2) creates distortions. RI (Part 4.2) produces negative values for a positive-NPV investment, potentially discouraging value-creating projects.',
        'Incentives: 10% of DP if positive is simple but has no cap and no downside. Moving to RI-based bonuses improves capital discipline but the bonus-on-improvement scheme rewards "getting worse first." Consider multi-year bonus pools or deferred compensation.',
      ],
