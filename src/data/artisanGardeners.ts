...
export const ARTISAN_GARDENERS: Simulation = {
  ...
  steps: [
    ...
    // ===== PART 3.2 =====
    {
      ...
      approach: [
        'Step 1 — Frame the question: We need to determine which alternative creates more value for AGL as a whole. The transfer price does not matter here because it is money moving from one AGL pocket to another — it cancels out at the company level. Only cash flows with the outside world matter.',
        'Step 2 — What is the same in both alternatives: Both serve the same 100 external NE clients at $2,000 per contract. Both incur the same variable cost of $840 per contract to perform the landscaping work (whether SE or NE does it, the materials and labor per contract are identical). Revenue is the same. Variable cost is the same.',
        'Step 3 — What is different: In Alt 1, SE already has idle workers and equipment — no additional fixed cost is needed. In Alt 2, NE must hire 4 new gardeners at $25,000 each = $100,000 of additional fixed cost that would not exist under Alt 1.',
        'Step 4 — Compute Alt 1 (SE transfers): Company cash flow = Revenue − VC = $200,000 − $84,000 = +$116,000. No additional costs because SE has spare capacity.',
        'Step 5 — Compute Alt 2 (NE hires): Company cash flow = Revenue − VC − Hiring = $200,000 − $84,000 − $100,000 = +$16,000. The hiring cost is a real incremental cash outflow that reduces the company\'s return.',
        'Step 6 — Compare: Alt 1 (+$116,000) is better than Alt 2 (+$16,000) by exactly $100,000. This $100,000 is the deadweight loss from duplicating resources that SE already has. The company should always prefer internal transfer when the seller has spare capacity.',
      ],
      answer: 'Alt 1: +$116,000 | Alt 2: +$16,000 | Alt 1 saves AGL $100,000',
      keyTakeaway: '💡 The logic: since both alternatives generate the same revenue and the same VC, the only difference is the $100,000 hiring cost. Alt 1 avoids this cost by using SE\'s idle capacity. The company clearly prefers Alt 1 — but will the transfer pricing system lead NE to choose it? That is the goal congruence test in Q21.',
    },
    {
      id: 'q21',
      partLabel: 'Part 3.2 — Hire vs Transfer',
