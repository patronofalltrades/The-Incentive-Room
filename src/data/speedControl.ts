...
export const SPEED_CONTROL: Simulation = {
  ...
  steps: [
    // ===== Q1 =====
    {
      ...
      approach: [
        ' Determine the relevant costs and revenues. From the CEO\'s perspective, the transfer price is irrelevant (it is an internal accounting entry). Only real cash flows matter: revenue from selling the 200k units, variable production costs, additional labor, and any investment or maintenance costs.',
        ' Derive per-unit figures. Price per unit = $12,000k / 500k = $24. Variable cost per unit = $6,000k / 500k = $12.',
        ' Evaluate producing at North. Revenue = $24 \u00D7 200k = $4,800k. Costs: variable manufacturing = $12 \u00D7 200k = $2,400k; labor = 15 \u00D7 $30k = $450k; fixed asset investment = $2,000k (written off at year-end with zero liquidation value); financing of NFO = 10% \u00D7 $1,500k = $150k. Net = $4,800k \u2212 $2,400k \u2212 $450k \u2212 $2,000k \u2212 $150k = \u2212$200k. This destroys value.',
        ' Evaluate producing at South. Revenue = $4,800k (same). Costs: variable manufacturing = $2,400k; labor = 15 \u00D7 $20k = $300k (cheaper labor); maintenance = $1,200k; shipping = $2 \u00D7 200k = $400k; financing of NFO = $150k. Net = $4,800k \u2212 $2,400k \u2212 $300k \u2212 $1,200k \u2212 $400k \u2212 $150k = +$350k.',
        ' Compare alternatives. South (+$350k) is clearly better than North (\u2212$200k). The key difference: South avoids the $2M fixed asset investment (which would be written off at year-end) and benefits from lower labor costs ($20k vs. $30k).',
      ],
      answer:
    ...
    // ===== Q2 =====
    {
      ...
      approach: [
        ' Determine the transfer price. TP = variable cost + 30% markup = $12 \u00D7 1.3 = $15.60 per unit. This is what North would pay South for each unit produced there.',
        ' Evaluate North\'s RI if produced at North. Change in OP = $4,800k (revenue) \u2212 $2,400k (variable) \u2212 $450k (labor) \u2212 $2,000k (depreciation of investment) = \u2212$50k. Change in assets = $2,000k (investment) + $1,500k (NFO) = $3,500k. Change in RI = \u2212$50k \u2212 10% \u00D7 $3,500k = \u2212$400k. North\'s RI drops, so no bonus.',
        ' Evaluate North\'s RI if produced at South. North records the revenue and pays the TP plus shipping. Change in OP = $4,800k \u2212 ($15.60 \u00D7 200k) \u2212 $400k (shipping) = $4,800k \u2212 $3,120k \u2212 $400k = +$1,280k. No asset change for North. Change in RI = +$1,280k. Bonus = 10% \u00D7 $1,280k = $128k.',
        ' Conclude. North\'s manager strongly prefers production at South (bonus of $128k vs. no bonus). This aligns with the CEO\'s preference.',
      ],
      answer:
    ...
    // ===== Q3 =====
    {
      ...
      approach: [
        ' Compute South\'s revenue from the transfer. South receives the transfer price: $15.60 \u00D7 200k = $3,120k.',
        ' Compute South\'s incremental costs. Variable manufacturing = $12 \u00D7 200k = $2,400k. Additional labor = 15 \u00D7 $20k = $300k. Maintenance = $1,200k. Total costs = $3,900k.',
        ' Compute change in South\'s operating profit. \u0394OP = $3,120k \u2212 $3,900k = \u2212$780k. The transfer price does not cover South\'s full incremental costs because the 30% markup on variable cost alone is insufficient to cover the additional fixed costs (labor + maintenance).',
        ' Compute change in South\'s RI. Additional assets = $1,500k (NFO). \u0394RI = \u2212$780k \u2212 10% \u00D7 $1,500k = \u2212$930k. South\'s RI worsens significantly.',
        ' Assess South\'s incentives. South already earns no bonus (budgeted RI is negative at \u2212$800k \u2212 10% \u00D7 $1,200k = \u2212$920k). Accepting makes RI even worse. The manager has no financial incentive to accept and every reason to refuse \u2014 more work, worse performance metrics, no bonus.',
      ],
      answer:
    ...
    // ===== Q4 =====
    {
      ...
      approach: [
        ...
        ' Allow direct negotiation. Since this is a one-time arrangement (last year of operations), let the two division managers negotiate the transfer price directly within the feasible range. This respects divisional autonomy and leverages local information.',
        ' Create a special compensation arrangement. Define a separate bonus for the 200,000 units that splits the total surplus ($350k) between both divisions. For example, each manager gets a percentage of the joint gain, incentivizing cooperation.',
        ' Note the trade-offs. Each solution has drawbacks: adjusting the TP policy may set precedents; negotiation has transaction costs; special arrangements add complexity. The choice depends on the organization\'s culture and the CEO\'s management style.',
      ],
      answer:
    ...
    // ===== Q5 =====
    {
      ...
      approach: [
        ' Compute South\'s new demand. South\'s current budgeted volume = 200,000 units. A 50% increase adds 100,000 units, bringing South to 300,000 units of own demand.',
        ' Check capacity. South\'s maximum capacity = 500,000 units. With its own demand (300,000) plus North\'s request (200,000) = 500,000 total. This exactly equals South\'s capacity.',
        ' Assess opportunity cost. Since South can accommodate both its own increased demand and North\'s 200,000 units without exceeding capacity, there is no opportunity cost of producing for North. South\'s idle capacity (previously 300,000 unused units) is simply being utilized more fully.',
        ' Conclude. The recommendation remains unchanged: produce at South. The second treaty does not create a conflict because South still has enough capacity. However, if South\'s demand increased further (beyond 300,000 of its own), the opportunity cost analysis would change.',
      ],
      answer:
