...
export const CIPRIANI_LOMBARDI: Simulation = {
  ...
  tableData: {
    ...
    rows: [
      ['Revenue (€000)', '24,000', '24,000'],
      ['  Number of pairs', '800,000', '750,000'],
      ['  Avg price per pair (€)', '30', '32'],
      ['Materials (€000)', '12,000', '12,000'],
      ...
      ['Divisional Profit (€000)', '1,330', '975'],
    ],
  },
  partContexts: [
    {
    ...
    },
    {
      ...
      tableData: {
        ...
        rows: [
          ...
          ['Standard variable manufacturing cost', '€15/pair'],
          ['Fixed manufacturing cost per pair (at 800k capacity)', '€6.50'],
          ['Standard full manufacturing cost', '€21.50'],
  ...
  steps: [
    ...
    },
    {
      ...
      question: 'Compute the selling price variance beyond the inflation effect. Inflation-adjusted price = €31.80, actual = €32.',
      formulaTex: 'V_{price} = (P_a - P_{inf}) \\times N_a = (32 - 31.80) \\times 750{,}000 = +150{,}000',
      formulaLegend: 'P_a = actual price (€32), P_{inf} = inflation-adjusted budget price (€30 × 1.06 = €31.80)',
      approach: [
        'Step 1: The selling price variance isolates how much the actual price exceeded the inflation-adjusted budget. This captures real pricing power beyond what inflation would predict.',
        'Step 2: Inflation-adjusted price = €30 × 1.06 = €31.80. Actual price = €32.',
        'Step 3: Real price increase = €32 − €31.80 = €0.20 per pair.',
        'Step 4: Variance = €0.20 × 750,000 = +€150,000.',
      ],
      answer: '+€150,000 (Favorable)',
      keyTakeaway: '💡 The real price increase beyond inflation is only €0.20 per pair. Most of the apparent price increase (€32 vs €30 = €2) is explained by inflation (€1.80), not genuine pricing power.',
    },
    {
      id: 'q4',
      partLabel: 'Part 1 — Variance Analysis',
    ...
    },
    {
      ...
      question: 'Compute the input price variance for materials beyond inflation. Inflation-adjusted cost/kg = €10.60, actual cost/kg = €10.',
      formulaTex: 'V_{ip} = -(C_a - C_{inf}) \\times Q_a \\times N_a = -(10 - 10.60) \\times 1.6 \\times 750{,}000 = +720{,}000',
      formulaLegend: 'C_a = actual cost per kg (€10), C_{inf} = inflation-adjusted budget cost per kg (€10 × 1.06 = €10.60), Q_a = actual kg per pair (1.6)',
      approach: [
        'Step 1: The input price variance isolates whether the actual cost per kg of materials differed from the inflation-adjusted budget. A favorable result means MAN paid less than inflation would predict.',
        'Step 2: Inflation-adjusted cost = €10 × 1.06 = €10.60. Actual cost = €10 per kg.',
        'Step 3: Real savings per kg = €10.60 − €10 = €0.60.',
        'Step 4: Variance = −(10 − 10.60) × 1.6 × 750,000 = 0.60 × 1,200,000 = +€720,000.',
        'Step 5: MAN sourced materials at €0.60/kg below the inflation-adjusted price. This is the largest favorable variance — but investigate whether cheaper materials contributed to the efficiency deterioration in Q4.',
      ],
      answer: '+€720,000 (Favorable)',
      keyTakeaway: '💡 MAN paid €10/kg versus an expected €10.60 after inflation — a significant saving. But cheaper materials may be lower quality, which could explain why more kg per pair were needed (Q4 efficiency variance = −€795k). The net materials effect is +€720k − €795k = −€75k unfavorable.',
    },
    {
      id: 'q6',
      partLabel: 'Part 1 — Variance Analysis',
    ...
    },
    {
      ...
      formulaTex: 'V_{OH} = -N_a \\times (OH_a - OH_b) = -750{,}000 \\times (1.40 - 1.40) = 0',
      formulaLegend: 'OH per pair is unchanged at €1.40. The volume effect on OH is already captured in Q1.',
      approach: [
        'Step 1: The corporate OH rate per pair did not change (€1.40 in both budget and actual).',
        'Step 2: The volume variance in Q1 already includes the OH effect (CM_b includes the €1.40 deduction).',
        'Step 3: Corporate OH variance = −750,000 × (1.40 − 1.40) = €0.',
      ],
      answer: '€0 (No variance)',
      keyTakeaway: '💡 The per-pair OH rate did not change, so there is no separate OH variance. The total OH difference (€1,120k vs €1,050k) is purely a volume effect already captured in Q1.',
    },
    {
      id: 'q10',
      partLabel: 'Part 1 — Variance Analysis',
      ...
      formulaTex: 'Bonus = 10\\% \\times \\max(DP_a - DP_b,\\, 0) = 10\\% \\times \\max(975 - 1{,}330,\\, 0) = 0',
      formulaLegend: 'DP_a = actual DP (€975k), DP_b = budget DP (€1,330k)',
      approach: [
        'Step 1: Actual DP = €975,000. Budget DP = €1,330,000.',
        'Step 2: Difference = 975 − 1,330 = −€355,000 (shortfall).',
        'Step 3: Since DP is below budget, bonus = €0.',
        'Step 4: Verification — sum of variances: −430 + 450 + 150 − 795 + 720 + 75 − 400 − 125 + 0 = −355. This matches the profit gap: 975 − 1,330 = −355.',
      ],
      answer: '€0',
      keyTakeaway: '💡 The variances sum to −€355k, matching the profit shortfall. Despite favorable inflation (+€450k) and input price (+€720k), the volume loss (−€430k), efficiency waste (−€795k), and FC overruns (−€525k) overwhelm the gains.',
    },
    // ===== PART 2 — External Pricing =====
    {
      id: 'q11',
      partLabel: 'Part 2 — External Pricing',
      questionTitle: 'Q11: Standard Manufacturing Full Cost and Price',
      question: 'A new low-cost customer (UFFS) wants to buy 30,000 pairs. Compute the standard manufacturing full cost per pair and the price using full cost + 20% markup.',
      formulaTex: 'Cost = VC + \\frac{FC}{N_{cap}} = 15 + \\frac{5{,}200{,}000}{800{,}000} = 15 + 6.5 = 21.50 \\quad P = 21.50 \\times 1.20 = 25.80',
      formulaLegend: 'VC = standard variable manufacturing cost (1.5 × €10 + €5... wait, standard VC = materials only = 1.5 × €10 = €15). FC per pair at capacity = €5,200k / 800k = €6.50.',
      approach: [
        'Step 1: Standard variable manufacturing cost per pair = 1.5 kg × €10/kg = €15 (materials only — other VC of €5 is not included in the manufacturing cost base for this calculation).',
        'Step 2: Fixed manufacturing cost per pair = €5,200,000 / 800,000 = €6.50.',
        'Step 3: Standard full manufacturing cost = €15 + €6.50 = €21.50.',
        'Step 4: Price with 20% markup = €21.50 × 1.20 = €25.80.',
      ],
      answer: 'Full cost = €21.50 | Price = €25.80 per pair',
      keyTakeaway: '💡 The standard VC for manufacturing is €15 (materials only), not €20. The €5 other VC and €1.40 corporate OH are separate from the manufacturing cost base used for pricing.',
    },
    {
      id: 'q12',
      partLabel: 'Part 2 — External Pricing',
      questionTitle: 'Q12: Cash Flow and Profit Effect of UFFS Order',
      question: 'Compute the additional cash flow contribution and additional divisional profit from the 30,000-pair UFFS order at €25.80. MAN has spare capacity.',
      formulaTex: '\\Delta CF = 30{,}000 \\times (25.80 - 15) = 324{,}000 \\quad \\Delta DP = 30{,}000 \\times (25.80 - 16.40) = 282{,}000',
      formulaLegend: 'CF uses VC = €15 (incremental cash cost). DP includes corporate OH at €1.40/pair (total incremental accounting cost = €16.40).',
      approach: [
        'Step 1: Cash flow perspective — incremental cost = VC only = €15. Contribution = (€25.80 − €15) × 30,000 = €324,000.',
        'Step 2: Divisional profit perspective — corporate OH is allocated at €1.40/pair on volume-based allocation. Incremental cost = €15 + €1.40 = €16.40.',
        'Step 3: Additional DP = (€25.80 − €16.40) × 30,000 = €282,000.',
        'Step 4: Bonus = 10% × €282,000 = €28,200. Wang benefits from the order.',
      ],
      answer: 'ΔCF = +€324,000 | ΔDP = +€282,000 | Bonus = €28,200',
      keyTakeaway: '💡 The €42,000 gap between CF (+€324k) and DP (+€282k) is caused by corporate OH allocation at €1.40 × 30,000 = €42,000. This is not a real cash cost — it is an accounting charge that reduces Wang\'s measured profit.',
    },
    {
      id: 'q13',
      partLabel: 'Part 2 — External Pricing',
      questionTitle: 'Q13: Minimum Acceptable Price',
      question: 'What is the minimum price MAN should accept for the UFFS order? MAN has spare capacity.',
      formulaTex: 'P_{min} = VC + OH_{pair} = 15 + 1.40 = 16.40',
      formulaLegend: 'VC = €15 (variable manufacturing cost), Corp OH = €1.40/pair. FC is sunk because MAN has spare capacity.',
      approach: [
        'Step 1: MAN has 50,000 pairs of spare capacity — enough for the 30,000-pair order.',
        'Step 2: FC is fixed regardless of the order — it is not relevant for the minimum price decision.',
        'Step 3: Incremental cost = VC (€15) + corporate OH (€1.40) = €16.40 per pair.',
        'Step 4: Any price above €16.40 adds to Wang\'s divisional profit. Any price above €15 adds to the company\'s cash flow.',
      ],
