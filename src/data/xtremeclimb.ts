...
export const XTREMECLIMB: Simulation = {
  ...
  steps: [
    // ===== PART 1.a =====
    {
      ...
      approach: [
        'Budgeted revenue per unit = 3,400/40 = \u20AC85.',
        'Budgeted materials per unit = (80/40) \u00D7 15 = \u20AC30.',
        'Budgeted other variable costs per unit = 360/40 = \u20AC9.',
        'Corporate OH per unit = \u20AC10.',
        'Budgeted CM per unit = 85 \u2212 30 \u2212 9 \u2212 10 = \u20AC36.',
        'Sales volume variance = (30 \u2212 40) \u00D7 36 = \u2212360 (\u2019000 \u20AC).',
      ],
    ...
    },
    {
      ...
      approach: [
        'Actual price per unit = 2,490/30 = \u20AC83.',
        'Budget price per unit = 3,400/40 = \u20AC85.',
        'Selling price variance = 30 \u00D7 (83 \u2212 85) = \u221260 (\u2019000 \u20AC).',
      ],
    ...
    },
    {
      ...
      approach: [
        'Budget fabric per unit = 80/40 = 2.0 meters.',
        'Actual fabric per unit = 84/30 = 2.8 meters.',
        'Efficiency variance = \u221230 \u00D7 (2.8 \u2212 2.0) \u00D7 15 = \u221230 \u00D7 0.8 \u00D7 15 = \u2212360 (\u2019000 \u20AC).',
      ],
      answer: '\u2212\u20AC360,000 (Unfavorable)',
      keyTakeaway:
    ...
    },
    {
      ...
      approach: [
        'Input price variance = \u221230 \u00D7 2.8 \u00D7 (13 \u2212 15) = \u221230 \u00D7 2.8 \u00D7 (\u22122) = +168 (\u2019000 \u20AC).',
      ],
    ...
    },
    {
      ...
      approach: [
        'Budget other VC per unit = 360/40 = \u20AC9.',
        'Actual other VC per unit = 273/30 = \u20AC9.1.',
        'Other VC variance = \u221230 \u00D7 (9.1 \u2212 9) = \u22123 (\u2019000 \u20AC).',
      ],
    ...
    },
    {
      ...
      approach: [
        'Actual Divisional Profit = \u2212\u20AC505,000.',
        'Budget Divisional Profit = \u20AC140,000.',
        'Since actual (\u2212505) < budget (140), John receives no bonus.',
      ],
      answer: '\u20AC0 (No bonus)',
      keyTakeaway:
    ...
    // ===== PART 1.b =====
    {
      ...
      approach: [
        'Original actual profit already includes corporate OH of 30 \u00D7 10 = \u20AC300,000.',
        'Under fixed allocation, corporate OH = \u20AC400,000.',
        'New actual profit = \u2212505 \u2212 (\u2212300) \u2212 400 = \u2212605 (\u2019000 \u20AC).',
      ],
      answer: '\u2212\u20AC605,000',
      keyTakeaway:
    ...
    },
    {
      ...
      approach: [
        'Under fixed OH, the corporate OH no longer varies with volume.',
        'New CM per unit = 85 \u2212 30 \u2212 9 = \u20AC46 (excluding OH).',
        'Sales volume variance = (30 \u2212 40) \u00D7 46 = \u2212460 (\u2019000 \u20AC).',
        'Equivalently: \u2212360 + [(30 \u2212 40) \u00D7 10] = \u2212360 \u2212 100 = \u2212460.',
      ],
    ...
    // ===== PART 2.a =====
    {
      ...
      approach: [
        'WD revenue (transfer price) = 39 \u00D7 1,000 = \u20AC39,000.',
        'WD manufacturing cost = 39 \u00D7 1,000 = \u20AC39,000.',
        'Additional corporate OH = 10 \u00D7 1,000 = \u20AC10,000.',
    ...
    },
    {
      ...
      approach: [
        'ED revenue from NW = 83 \u00D7 1,000 = \u20AC83,000.',
        'Cost of units from WD = 39 \u00D7 1,000 = \u20AC39,000.',
        'Transportation WD\u2192ED = \u20AC5,000.',
        'Additional corporate OH = 10 \u00D7 1,000 = \u20AC10,000.',
    ...
    },
    {
      ...
      approach: [
        'XC revenue = 83 \u00D7 1,000 = \u20AC83,000.',
        'Manufacturing cost = 39 \u00D7 1,000 = \u20AC39,000.',
        'Transportation = \u20AC5,000.',
        'Net effect on XC = 83,000 \u2212 39,000 \u2212 5,000 = +\u20AC39,000.',
        'Corporate OH cancels out at the company level.',
      ],
      answer: '+\u20AC39,000',
      keyTakeaway:
    ...
    // ===== PART 2.b =====
    {
      ...
      approach: [
        'Alt 1 (sell to ED): revenue 39,000 \u2212 cost 39,000 \u2212 OH 10,000 = \u221210,000.',
        'Alt 2 (sell to SF): revenue 70,000 \u2212 cost 39,000 \u2212 OH 10,000 = +21,000.',
        'Difference (Alt 1 \u2212 Alt 2) = \u221210,000 \u2212 21,000 = \u2212\u20AC31,000.',
      ],
      answer: '\u2212\u20AC31,000',
      keyTakeaway:
    ...
    },
    {
      ...
      approach: [
        'ED perspective is identical to Part 2.a.',
        'Net effect on ED = 83,000 \u2212 39,000 \u2212 5,000 \u2212 10,000 = +\u20AC29,000.',
      ],
      answer: '+\u20AC29,000',
      keyTakeaway:
    ...
    },
    {
      ...
      approach: [
        'Alt 1: XC revenue 83,000, cost 39,000, transport 5,000.',
        'Alt 2: XC revenue 70,000, cost 39,000, no transport.',
        'Difference = (83,000 \u2212 39,000 \u2212 5,000) \u2212 (70,000 \u2212 39,000) = 39,000 \u2212 31,000 = +\u20AC8,000.',
      ],
      answer: '+\u20AC8,000',
      keyTakeaway:
    ...
    // ===== PART 3.a =====
    {
      ...
      approach: [
        'Standard fixed cost per unit = 800,000 / 40,000 = \u20AC20.',
        'This rate is the same for both HC and LC because XC allocates equally regardless of product type.',
      ],
      answer: '\u20AC20 per unit',
      keyTakeaway:
    ...
    },
    {
      ...
      approach: [
        'Standard manufacturing full cost of LC = 10 + 20 = \u20AC30.',
        'Price = 30 \u00D7 1.45 = \u20AC43.50.',
      ],
    ...
    },
    {
      ...
      approach: [
        "LC revenue = 43.5 \u00D7 2,000 = \u20AC87,000 ('000: 87).",
        'LC variable cost = 10 \u00D7 2,000 = \u20AC20,000.',
        'HC price drop = (83 \u2212 85) \u00D7 30,000 = \u2212\u20AC60,000.',
        'Net effect on XC cash flows = 87 \u2212 20 \u2212 60 = +\u20AC7,000.',
      ],
      answer: '+\u20AC7,000',
      keyTakeaway:
    ...
    },
    {
      ...
      approach: [
        'Change in WD profit: +87 (LC revenue) \u2212 20 (LC variable cost) \u2212 60 (HC price drop) \u2212 20 (additional corporate OH on 2,000 extra units) = \u221213 (\u2019000 \u20AC).',
        'Since WD profit decreases by \u20AC13,000, John receives no bonus from LC.',
      ],
    ...
    // ===== PART 3.b =====
    {
      ...
      approach: [
        'Expected volume = 30,000 + 2,000 = 32,000 units.',
        'Fixed cost per unit = 800,000 / 32,000 = \u20AC25.',
        'Price of LC = 1.45 \u00D7 (10 + 25) = 1.45 \u00D7 35 = \u20AC50.75.',
      ],
    ...
    // ===== PART 4.a =====
    {
      ...
      approach: [
        '2018: Cash outflow = \u2212\u20AC900,000.',
        '2019\u20132021: Variable cost savings = (39 \u2212 29) \u00D7 30,000 = \u20AC300,000/year.',
        'Labor savings = \u20AC100,000/year.',
        'Annual cash inflow = 300,000 + 100,000 = \u20AC400,000/year.',
      ],
    ...
    },
    {
      ...
      approach: [
        ...
        'Annual depreciation = 900,000 / 3 = \u20AC300,000.',
        'Effect on Divisional Profit = 400,000 \u2212 300,000 = +\u20AC100,000 per year.',
        'Corporate OH does not change (same number of units sold).',
      ],
    ...
    // ===== PART 4.b =====
    {
      ...
      approach: [
        '2019: Change in RI due to investment = 400 \u2212 300 \u2212 0.1 \u00D7 900 = 100 \u2212 90 = 10 (\u2019000 \u20AC). Bonus effect = 10% \u00D7 10,000 = \u20AC1,000.',
        '2020: Additional change in RI = 0.1 \u00D7 (900/3) = 30 (\u2019000 \u20AC). Bonus effect = 10% \u00D7 30,000 = \u20AC3,000.',
        '2021: Same as 2020. Bonus effect = \u20AC3,000.',
      ],
    ...
    },
    {
      ...
      approach: [
        '2019: Depreciation = 0.1 \u00D7 900 = 90. Capital charge = 0.1 \u00D7 900 = 90. Change in RI = 400 \u2212 90 \u2212 90 = 220 (\u2019000 \u20AC). Bonus = 10% \u00D7 220,000 = \u20AC22,000.',
        '2020: Change in RI relative to 2019 = \u22120.2 \u00D7 900 + 0.1 \u00D7 0.1 \u00D7 900 = \u2212180 + 9 = \u2212171 < 0. Bonus = \u20AC0.',
        '2021: Change in RI relative to 2020 = \u22120.3 \u00D7 900 + 0.1 \u00D7 0.3 \u00D7 900 = \u2212270 + 27 = \u2212243 < 0. Bonus = \u20AC0.',
      ],
