...
export const FRANKFURTER: Simulation = {
  ...
  steps: [
    // ===== Q1 =====
    {
      ...
      approach: [
        ' Compute budgeted profit as the starting point. Budgeted labor cost per sausage = \u20AC15 / 300 = \u20AC0.05. Budgeted contribution margin per unit = \u20AC4.00 \u2212 \u20AC0.85 \u2212 \u20AC0.05 \u2212 \u20AC0.30 = \u20AC2.80. Budgeted profit = 1,500,000 \u00D7 \u20AC2.80 \u2212 \u20AC900,000 = \u20AC3,300,000.',
        ' Compute actual profit. Actual labor cost per sausage = \u20AC15 / 250 = \u20AC0.06. Actual profit = 1,200,000 \u00D7 (\u20AC3.70 \u2212 \u20AC0.80 \u2212 \u20AC0.06 \u2212 \u20AC0.40) \u2212 \u20AC950,000 = 1,200,000 \u00D7 \u20AC2.44 \u2212 \u20AC950,000 = \u20AC1,978,000. Total variance = \u20AC1,978,000 \u2212 \u20AC3,300,000 = \u2212\u20AC1,322,000.',
        ' Volume shortfall = 1,200,000 / 1,500,000 = 80%. Volume variance = (0.80 \u2212 1) \u00D7 1,500,000 \u00D7 \u20AC2.80 = \u2212\u20AC840,000.',
        ' Compute the selling price variance. Evaluated at actual volume to avoid double-counting: 1,200,000 \u00D7 (\u20AC3.70 \u2212 \u20AC4.00) = 1,200,000 \u00D7 (\u2212\u20AC0.30) = \u2212\u20AC360,000. The premium price eroded, possibly due to competitive pressure.',
        ' Compute the material price variance. Material cost fell from \u20AC0.85 to \u20AC0.80 per sausage. Variance = \u22121,200,000 \u00D7 (\u20AC0.80 \u2212 \u20AC0.85) = +\u20AC60,000. Favorable: cheaper materials were sourced.',
        ' Compute the labor efficiency variance. Budget: \u20AC15/300 = \u20AC0.05/sausage. Actual: \u20AC15/250 = \u20AC0.06/sausage. Variance = \u22121,200,000 \u00D7 (\u20AC0.06 \u2212 \u20AC0.05) = \u2212\u20AC12,000. Unfavorable: lower productivity (250 vs. 300 sausages/hour). Note: the hourly labor rate stayed at \u20AC15, so there is no input price variance for labor.',
        ' Compute the marketing cost variance. Budget: \u20AC0.30. Actual: \u20AC0.40. Variance = \u22121,200,000 \u00D7 (\u20AC0.40 \u2212 \u20AC0.30) = \u2212\u20AC120,000. Unfavorable: higher marketing spend per sausage, possibly an attempt to stimulate weak demand.',
        ' Compute the fixed overhead variance. Fixed costs rose from \u20AC900,000 to \u20AC950,000. Variance = \u2212(\u20AC950,000 \u2212 \u20AC900,000) = \u2212\u20AC50,000. Unfavorable.',
        ' Reconcile. Total = \u2212\u20AC840,000 \u2212 \u20AC360,000 + \u20AC60,000 \u2212 \u20AC12,000 \u2212 \u20AC120,000 \u2212 \u20AC50,000 = \u2212\u20AC1,322,000. Matches the total profit shortfall.',
      ],
      answer:
    ...
    // ===== Q2 =====
    {
      ...
      question:
        'Provide a possible interpretation for the analysis.',
      approach: [
        ' Assess overall performance. The company performed poorly along nearly all dimensions. Volume fell 20%, price dropped \u20AC0.30, marketing costs rose, labor productivity declined, and fixed costs increased. Only material costs improved.',
        ...
        ' Consider the demand picture. The volume shortfall (\u2212\u20AC840k) and price decline (\u2212\u20AC360k) together account for \u20AC1.2M of the \u20AC1.32M shortfall. This suggests a fundamental demand problem \u2014 perhaps the premium positioning is under pressure. The increased marketing spend (+\u20AC120k unfavorable) may have been an unsuccessful attempt to combat the demand weakness.',
        ' Note the optimistic budgeting. Frank is described as an "eternal optimist." The 1,500,000 target may have been unrealistically ambitious, making the variances look worse than actual performance warrants.',
      ],
      answer:
