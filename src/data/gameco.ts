...
export const GAMECO: Simulation = {
  ...
  steps: [
    // ===== PART A =====
    {
      ...
      formulaTex:
        '\\text{Revenue}_{GameCo} = 550{,}000 \\times 10\\% \\times \\euro 20 = \\euro 1{,}100{,}000',
      formulaLegend:
        '550,000 users, 10% purchasing, \u20AC20 per paying user',
      approach: [
        'Only paying users generate revenue for GameCo.',
        'Revenue = 550,000 \u00D7 0.10 \u00D7 \u20AC20 = \u20AC1,100,000.',
      ],
      answer: '\u20AC1,100,000',
      keyTakeaway:
    ...
    },
    {
      ...
      formulaTex:
        '\\text{Revenue}_{CG} = 550{,}000 \\times 10\\% \\times \\euro 20 = \\euro 1{,}100{,}000',
      formulaLegend:
        'CG receives revenue directly from paying gamers',
      approach: [
        'CG earns revenue from gamers purchasing power bars.',
        'Revenue = 550,000 \u00D7 0.10 \u00D7 \u20AC20 = \u20AC1,100,000.',
      ],
      answer: '\u20AC1,100,000',
      keyTakeaway:
    ...
    },
    {
      ...
      formulaTex:
        '\\text{Revenue}_{UE} = 15{,}000 \\times \\euro 60.5 + 550{,}000 \\times \\euro 0.02 = \\euro 907{,}500 + \\euro 11{,}000 = \\euro 918{,}500',
      formulaLegend:
        'UE revenue = development transfer payments + user service transfer payments',
      approach: [
        'Development revenue = 15,000 hours \u00D7 \u20AC60.5/hr = \u20AC907,500.',
        'User service revenue = 550,000 users \u00D7 \u20AC0.02 = \u20AC11,000.',
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta \\pi_{GameCo} = 1{,}100 - 15 \\times 25 - 2 \\times 70 - 3 \\times 70 = 1{,}100 - 375 - 140 - 210 = +375 \\text{ (\'000 \\euro)}',
      formulaLegend:
        'Revenue 1,100; Developer cost 375; UE employees 140; CG employees 210. All in thousands.',
      approach: [
        'Revenue = \u20AC1,100,000.',
        'External developer cost = 15,000 \u00D7 \u20AC25 = \u20AC375,000.',
        'UE additional employees = 2 \u00D7 \u20AC70,000 = \u20AC140,000.',
        'CG additional employees = 3 \u00D7 \u20AC70,000 = \u20AC210,000.',
        'GameCo profit from HP = 1,100,000 \u2212 375,000 \u2212 140,000 \u2212 210,000 = +\u20AC375,000.',
      ],
      answer: '+\u20AC375,000',
      keyTakeaway:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta \\pi_{CG} = 1{,}100 - 15 \\times 60.5 - 550 \\times 0.02 - 3 \\times 70 = 1{,}100 - 907.5 - 11 - 210 = -28.5 \\text{ (\'000 \\euro)}',
      formulaLegend:
        'Revenue 1,100; Development TP 907.5; User service TP 11; Marketing employees 210. All in thousands.',
      approach: [
        'Revenue = \u20AC1,100,000.',
        'Payment to UE for development = 15,000 \u00D7 \u20AC60.5 = \u20AC907,500.',
        'Payment to UE for user services = 550,000 \u00D7 \u20AC0.02 = \u20AC11,000.',
        'CG marketing employees = 3 \u00D7 \u20AC70,000 = \u20AC210,000.',
        'CG divisional profit = 1,100,000 \u2212 907,500 \u2212 11,000 \u2212 210,000 = \u2212\u20AC28,500.',
      ],
      answer: '\u2212\u20AC28,500',
      keyTakeaway:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta \\pi_{UE} = 15 \\times 60.5 + 550 \\times 0.02 - 15 \\times 25 - 2 \\times 70 = 907.5 + 11 - 375 - 140 = +403.5 \\text{ (\'000 \\euro)}',
      formulaLegend:
        'TP revenue 918.5; Developer cost 375; UE employees 140. All in thousands.',
      approach: [
        'Revenue from CG for development = \u20AC907,500.',
        'Revenue from CG for user services = \u20AC11,000.',
        'External developer cost = 15,000 \u00D7 \u20AC25 = \u20AC375,000.',
        'UE additional employees = 2 \u00D7 \u20AC70,000 = \u20AC140,000.',
        'UE divisional profit = 907,500 + 11,000 \u2212 375,000 \u2212 140,000 = +\u20AC403,500.',
      ],
      answer: '+\u20AC403,500',
      keyTakeaway:
    ...
    },
    {
      ...
      approach: [
        'HP is profitable for GameCo (+\u20AC375,000) but CG would reject it (\u2212\u20AC28,500). No goal congruence.',
        "The development TP charges CG for all of UE's fixed costs (designers, anthropologists). The \u20AC30/hr fixed cost rate is based on actual hours, making CG absorb UE's idle capacity.",
        'If UE does not sell externally, defining it as a profit center is questionable.',
        'Alternatives: (a) base fixed cost rate on capacity hours to lower the TP, (b) let divisions negotiate, (c) introduce common performance measures (e.g., stock options), (d) use non-financial KPIs like total users.',
      ],
      answer:
    ...
    // ===== PART B =====
    {
      ...
      formulaTex:
        '\\Delta OH_{GameCo} = \\euro 0',
      formulaLegend:
        'HP does not alter corporate overhead for the company as a whole; the charge is an internal allocation.',
      approach: [
        'Corporate overhead is a cost incurred by the headquarters.',
        'HP does not change the actual corporate overhead costs.',
        'The \u20AC50,000/employee charge is an allocation, not an incremental cost.',
      ],
      answer: '\u20AC0 (None)',
      keyTakeaway:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta OH_{CG} = 3 \\times \\euro 50{,}000 = \\euro 150{,}000',
      formulaLegend:
        '3 additional marketing employees at CG \u00D7 \u20AC50,000 each',
      approach: [
        'CG hires 3 additional marketing employees for HP.',
        'Corporate OH charge = 3 \u00D7 \u20AC50,000 = \u20AC150,000.',
      ],
      answer: '\u20AC150,000',
      keyTakeaway:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta OH_{UE} = 2 \\times \\euro 50{,}000 = \\euro 100{,}000',
      formulaLegend:
        '2 additional service employees at UE \u00D7 \u20AC50,000 each',
      approach: [
        'UE hires 2 additional service employees for HP.',
        'Corporate OH charge = 2 \u00D7 \u20AC50,000 = \u20AC100,000.',
      ],
      answer: '\u20AC100,000',
      keyTakeaway:
    ...
    // ===== PART C =====
    {
      ...
      formulaTex:
        '\\Delta \\pi_{GameCo}^{2016} = 550 \\times 0.1 \\times 20 - 15 \\times 25/2 - 2 \\times 70 - 3 \\times 70 = 1{,}100 - 187.5 - 140 - 210 = +562.5 \\text{ (\'000 \\euro)}',
      formulaLegend:
        'Revenue = 1,100; Development allocated over 2 years = 375/2 = 187.5; Employees = 350. All in thousands.',
      approach: [
        'Revenue in 2016 = \u20AC1,100,000 (same as 1-year case).',
        'Development cost allocated to 2016 = (15,000 \u00D7 25) / 2 = \u20AC187,500.',
        'Employee costs in 2016 = (2 + 3) \u00D7 70,000 = \u20AC350,000.',
        'GameCo profit in 2016 = 1,100,000 \u2212 187,500 \u2212 350,000 = +\u20AC562,500.',
      ],
      answer: '+\u20AC562,500',
      keyTakeaway:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta \\pi_{CG}^{2016} = 1{,}100 - 15 \\times 60.5/2 - 550 \\times 0.02 - 3 \\times 70 - 3 \\times 50 = +275.25 \\text{ (\'000 \\euro)}',
      formulaLegend:
      ...
      approach: [
        'Revenue = \u20AC1,100,000.',
        'Development TP allocated to 2016 = (15,000 \u00D7 60.5) / 2 = \u20AC453,750.',
        'User service TP = 550,000 \u00D7 0.02 = \u20AC11,000.',
        'Marketing employees = 3 \u00D7 \u20AC70,000 = \u20AC210,000.',
        'Corporate OH = 3 \u00D7 \u20AC50,000 = \u20AC150,000.',
        'CG profit = 1,100,000 \u2212 453,750 \u2212 11,000 \u2212 210,000 \u2212 150,000 = +\u20AC275,250.',
      ],
      answer: '+\u20AC275,250',
      keyTakeaway:
    ...
    },
    {
      ...
      formulaTex:
        '\\Delta \\pi_{UE}^{2016} = 15 \\times 60.5/2 + 550 \\times 0.02 - 15 \\times 25/2 - 2 \\times 70 - 2 \\times 50 = +37.25 \\text{ (\'000 \\euro)}',
      formulaLegend:
        'Dev revenue allocated = 453.75; User service 11; Dev cost allocated = 187.5; Employees 140; OH 100. All in thousands.',
      approach: [
        'Development revenue allocated to 2016 = (15,000 \u00D7 60.5) / 2 = \u20AC453,750.',
        'User service revenue = \u20AC11,000.',
        'Developer cost allocated to 2016 = (15,000 \u00D7 25) / 2 = \u20AC187,500.',
        'UE employees = 2 \u00D7 \u20AC70,000 = \u20AC140,000.',
        'Corporate OH = 2 \u00D7 \u20AC50,000 = \u20AC100,000.',
