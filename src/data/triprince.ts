...
export const TRIPRINCE: Simulation = {
  ...
  steps: [
    // ===== Q1 =====
    {
      ...
      approach: [
        ' Compute activity cost rates. The essence of ABC is to assign costs based on what actually drives them, not on a single volume-based measure. Rate per order = \u20AC80,000 / 2,000 = \u20AC40/order. Rate per line item = \u20AC63,840 / 21,280 = \u20AC3/item. Rate per delivery = \u20AC71,000 / 1,420 = \u20AC50/delivery. Rate per carton = \u20AC76,000 / 76,000 = \u20AC1/carton. Rate per stacking hour = \u20AC10,240 / 640 = \u20AC16/hour.',
        ' Determine driver quantities per channel. Supermarkets: 140 orders, 14\u00D7140 = 1,960 line items, 120 deliveries, 36,000 cartons, 3.0\u00D7120 = 360 stacking hours. Drugstores: 360 orders, 12\u00D7360 = 4,320 line items, 300 deliveries, 24,000 cartons, 0.6\u00D7300 = 180 hours. Pharmacies: 1,500 orders, 10\u00D71,500 = 15,000 line items, 1,000 deliveries, 16,000 cartons, 0.1\u00D71,000 = 100 hours.',
        ' Allocate costs to Supermarkets. \u20AC40\u00D7140 + \u20AC3\u00D71,960 + \u20AC50\u00D7120 + \u20AC1\u00D736,000 + \u20AC16\u00D7360 = \u20AC5,600 + \u20AC5,880 + \u20AC6,000 + \u20AC36,000 + \u20AC5,760 = \u20AC59,240. The largest driver is carton shipping (\u20AC36k), reflecting the large physical volume of supermarket shipments.',
        ' Allocate costs to Drugstores. \u20AC40\u00D7360 + \u20AC3\u00D74,320 + \u20AC50\u00D7300 + \u20AC1\u00D724,000 + \u20AC16\u00D7180 = \u20AC14,400 + \u20AC12,960 + \u20AC15,000 + \u20AC24,000 + \u20AC2,880 = \u20AC69,240.',
        ' Allocate costs to Pharmacies. \u20AC40\u00D71,500 + \u20AC3\u00D715,000 + \u20AC50\u00D71,000 + \u20AC1\u00D716,000 + \u20AC16\u00D7100 = \u20AC60,000 + \u20AC45,000 + \u20AC50,000 + \u20AC16,000 + \u20AC1,600 = \u20AC172,600. Pharmacies receive 57% of total allocated costs despite generating only 23% of revenue. The key drivers: 1,500 orders (75% of all orders) and 1,000 deliveries (70% of all deliveries).',
        ' Verify total and compute operating income. Total allocated = \u20AC59,240 + \u20AC69,240 + \u20AC172,600 = \u20AC301,080 (matches). Operating income: Supermarkets = \u20AC108,000 \u2212 \u20AC59,240 = \u20AC48,760. Drugstores = \u20AC150,000 \u2212 \u20AC69,240 = \u20AC80,760. Pharmacies = \u20AC180,000 \u2212 \u20AC172,600 = \u20AC7,400.',
        ' Highlight the key finding. Despite having the highest gross margin percentage (9.09%), pharmacies have the lowest operating income (\u20AC7,400). This is the core insight of ABC: gross margin percentage is misleading when cost-to-serve differs dramatically across channels. The pharmacy channel generates many small orders requiring frequent deliveries, driving up operating costs per unit of revenue.',
      ],
      answer:
    ...
    // ===== Q2 =====
    {
      ...
      approach: [
        ' Address the pharmacy channel (market orientation). The pharmacy channel is barely profitable because of the high cost-to-serve from many small orders and frequent deliveries. Recommendations: implement minimum order sizes or surcharges for small orders; adjust pricing to reflect the true cost-to-serve; use CRM tools to incentivize pharmacies to consolidate orders into fewer, larger batches.',
        ' Improve supply chain efficiency (operational orientation). Reduce the number of individual deliveries to pharmacies by encouraging larger, less frequent orders. Explore hub-and-spoke delivery models. Investigate whether order processing can be streamlined or automated for the high-volume pharmacy channel.',
        ' Fix the internal accounting system. Stop evaluating channels on gross margin percentage alone \u2014 it is misleading when operating costs vary so dramatically across channels. Incorporate ABC-based cost-to-serve analysis into regular channel profitability reviews. Separately identify and manage idle capacity costs rather than spreading them across channels.',
      ],
      answer:
