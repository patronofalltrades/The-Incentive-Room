...
export const BARCELONA_MED_FOOD: Simulation = {
  ...
  steps: [
    // ===== PART 1 =====
    {
      ...
      approach: [
        ' Compute the revenue loss from selling fewer meals. The restaurant sold 29,000 vs. 31,000 budgeted. At the budgeted price of \u20AC16: revenue effect = (29,000 \u2212 31,000) \u00D7 \u20AC16 = \u2212\u20AC32,000. This is the gross revenue impact of 2,000 fewer meals.',
        ' Compute the materials savings on the 1,000 fewer in-house meals. Only in-house meals use materials. In-house meals dropped from 30,000 to 29,000 (1,000 fewer). At the budgeted efficiency of 0.4 kg/meal and \u20AC10.50/kg: savings = \u2212(29,000 \u2212 30,000) \u00D7 0.4 \u00D7 \u20AC10.50 = +\u20AC4,200.',
        ' Compute the part-time waiter savings. The waiter is only needed when volume exceeds 30,000. Since actual volume was 29,000, the waiter was let go in H2. Savings = \u2212\u20AC5,500 \u2212 (\u2212\u20AC11,000) = +\u20AC5,500. This is a step-cost effect: dropping below the threshold eliminates the cost.',
        ' Compute the outsourced meal cost savings. No meals were outsourced, saving the full outsourcing cost. Savings = 0 \u2212 (\u2212\u20AC5,000) = +\u20AC5,000.',
        ' Add the compensation received from the outsourcer. The outsourcer compensated BMF for the contribution margin on the 500 meals it failed to deliver in H1: 500 \u00D7 (\u20AC16 \u2212 \u20AC5) = +\u20AC5,500.',
        ' Compute corporate OH savings from lower volume. OH savings = \u2212\u20AC0.10 \u00D7 (29,000 \u2212 31,000) = +\u20AC200.',
        ' Sum all volume-related effects. Total volume variance = \u2212\u20AC32,000 + \u20AC4,200 + \u20AC5,500 + \u20AC5,000 + \u20AC5,500 + \u20AC200 = \u2212\u20AC11,600. The revenue loss dominates, but cost savings partially offset it.',
      ],
    ...
    },
    {
      ...
      approach: [
        ' Average price dropped from \u20AC16 to \u20AC14 (\u20AC2 decrease).',
        ' Identify the prices. Budget price = \u20AC16. Actual average price = \u20AC14 (H1 at \u20AC16, H2 at \u20AC12, averaging to \u20AC14). The \u20AC2 drop is entirely due to the H2 price reduction to attract customers after the supply disruption.',
        ' Compute the variance. Selling price variance = 29,000 \u00D7 (\u20AC14 \u2212 \u20AC16) = 29,000 \u00D7 (\u2212\u20AC2) = \u2212\u20AC58,000. This is the single largest variance in the entire analysis.',
      ],
    ...
    },
    {
      ...
      approach: [
        ' Budget efficiency = 0.400 kg/meal. Actual = 0.379 kg/meal (improved by 0.021 kg).',
        ' Compute the efficiency ratios. Budget efficiency = 12,000 kg / 30,000 meals = 0.400 kg/meal. Actual efficiency = 11,000 kg / 29,000 meals \u2248 0.379 kg/meal. The restaurant used 0.021 fewer kg per meal than budgeted.',
        ' Compute the variance. Valued at the budgeted price (\u20AC10.50/kg) to isolate the pure efficiency effect: Variance = \u221229,000 \u00D7 (0.379 \u2212 0.400) \u00D7 \u20AC10.50 = \u221229,000 \u00D7 (\u22120.021) \u00D7 \u20AC10.50 \u2248 +\u20AC6,300. This is favorable \u2014 the kitchen used less material per meal.',
      ],
    ...
    },
    {
      ...
      approach: [
        ' Material price fell from \u20AC10.50 to \u20AC9.60/kg (\u2212\u20AC0.90).',
        ' Identify the prices and quantity. Budget price = \u20AC10.50/kg. Actual price = \u20AC9.60/kg (a \u20AC0.90 saving). Actual quantity per meal = 0.379 kg.',
        ' Compute the variance. Input price variance = \u221229,000 \u00D7 0.379 \u00D7 (\u20AC9.60 \u2212 \u20AC10.50) = \u221229,000 \u00D7 0.379 \u00D7 (\u2212\u20AC0.90) \u2248 +\u20AC9,900. This is favorable \u2014 BMF secured cheaper materials in H2.',
      ],
    ...
    },
    {
      ...
      approach: [
        ' OH rate fell from \u20AC0.10 to \u20AC0.05/meal.',
        ' Identify the rates. Budget OH rate = \u20AC0.10/meal. Actual OH rate = \u20AC0.05/meal. The rate was halved, likely due to corporate-level cost changes.',
        ' Compute the variance at actual volume. OH rate variance = \u221229,000 \u00D7 (\u20AC0.05 \u2212 \u20AC0.10) = \u221229,000 \u00D7 (\u2212\u20AC0.05) = +\u20AC1,450. Favorable, but entirely outside the restaurant manager\'s control.',
      ],
    ...
    },
    {
      ...
      approach: [
        ' List all variances to verify completeness. A correct variance analysis must sum exactly to the total profit difference. This is the integrity check.',
        ' Sum the variances. Volume: \u2212\u20AC11,600 + Selling price: \u2212\u20AC58,000 + Input efficiency: +\u20AC6,300 + Input price: +\u20AC9,900 + Corporate OH rate: +\u20AC1,450 = \u2212\u20AC51,950.',
        ' Verify against the profit difference. Budget profit \u2212 Actual profit = \u20AC140,900 \u2212 \u20AC88,950 = \u20AC51,950. The variances reconcile exactly, confirming the analysis is complete and no variance has been missed.',
      ],
    ...
    // ===== PART 2 =====
    {
      ...
      approach: [
        ' Identify the dominant variance. The selling price variance of \u2212\u20AC58,000 is by far the largest unfavorable variance, accounting for more than the entire profit shortfall. Without it, the other variances would have netted to approximately +\u20AC6,000.',
        ' Trace the cause. The price drop (from \u20AC16 to an average of \u20AC14, with H2 at \u20AC12) was the restaurant manager\u2019s response to the demand drop caused by turning away customers during the H1 supply disruption. He cut prices aggressively to re-attract customers.',
        ' Evaluate the decision. The price adjustment may have been an overreaction. The volume variance (\u2212\u20AC11,600) was relatively modest thanks to cost savings and outsourcer compensation. The manager traded \u20AC58,000 in price to recover some volume, but the net outcome was worse.',
        ' Note the limitation. This conclusion is tentative: we do not know what demand would have been in H2 without the price reduction. It is possible that without the cut, volume would have been even lower.',
      ],
      answer:
